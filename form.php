...
<body>
  ...
  <header>
      ...
      <!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap" style="margin-top: 100px;">Add</button> -->
      ...
      <footer class="page-footer font-small blue-grey lighten-5" style="margin-top: 615px;">
