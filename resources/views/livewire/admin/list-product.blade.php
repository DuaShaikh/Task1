                    ...
                    <table class="table table-striped ">
                        <thead class="table-dark" >
                                <tr>
                                    ...
                                    <th scope="col">Name
                                        <span wire:click="sortBy('pName')" class="arrowStyle">
                                            <i class="fa fa-arrow-up {{$sortColumnName === 'pName' && $sortDirection === 'asc' ? '' : 'text-muted'}}"></i>
                                            <i class="fa fa-arrow-down {{$sortColumnName === 'pName' && $sortDirection === 'desc' ? '' : 'text-muted'}}"></i>
                                        </span>
                                    </th>
