<div class="page-container"></div>
    <div class="login-reg-panel">                   
        <div class="register-info-box">
            ...
            <div class="white-panel pt-4">
                <p>
                    <a href="/auth" class="btn btn-block btn-google" style="color:white"> <i class="fab fa-google"></i>   Login via google</a>
        
                    <a href="/auth/facebook" class="btn btn-block btn-facebook" style='color:white'> <i class="fab fa-facebook-f"></i>  Login via Facebook</a>
                </p>
