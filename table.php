  ...
  <body>
    ...
    <div class="container"style="margin-top:-40px">
      ...
      $result = retrivedData($conn, $limit=10);
    ...
    console.log(search_term);
      $.ajax({
       ...
       $('#table_data tbody').append($('<tr>')
                ...
                .append('<td>' +  + '</td>')
                .append('<td> <a href="http://task.me/function.php?function=show&id=' + val.id + ' "> <i class="fas fa-pencil-alt"></i></a> </td>')
                .append('<td><a href="http://task.me/table.php?function=duplicateData&id='+ val.id +' "><i class="far fa-copy"></i> </a></td>')
                .append('<td><a href="http://task.me/function.php?function=deleteData&id='+ val.id +' "> <i class="fas fa-trash"> </i> </a></td>')
                ) 
